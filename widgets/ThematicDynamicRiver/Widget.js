...
define([
	...
	function (declare,
		...
		return declare([BaseWidget], {
			baseClass: 'jimu-widget-ThematicDynamicRiver',
			name: 'ThematicDynamicRiver',
			riverWidth: 200,
			riverHeight: 10,
			speed: 10,
			positions: [],
			...
			startup: function () {
				...
				$('#thematic_qcsmx_headtab').click(function () {
					self.map.entities.remove(self.drawingPolyline);
				...
				$("#thematic_hlgd_headtab").change(function (e) {
